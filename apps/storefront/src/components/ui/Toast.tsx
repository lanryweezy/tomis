...
export function ToastProvider({ children }: { children: React.ReactNode }) {
  ...
  // ⚡ Bolt Optimization: Memoize the ToastContext value
  // Impact: Prevents unnecessary cascading re-renders in all components
  // consuming useToast() whenever the ToastProvider re-renders.
