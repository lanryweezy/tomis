...
export default function WhatsAppChat() {
  ...
  if (pathname === '/checkout' || pathname === '/checkout/verify') {
    return null;
  }
  ...
  return (
    <>
      <motion.button
        ...
        className="focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--accent)] rounded-full"
