  ...
  return (
    <>
      <motion.button
        ...
        style={{ position: 'fixed', bottom: '2rem', left: '2rem', width: '3.5rem', height: '3.5rem', backgroundColor: '#25D366', color: 'white', border: 'none', borderRadius: '50%', cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1100, boxShadow: '0 4px 12px rgba(37,211,102,0.4)' }}
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <div style={{ backgroundColor: '#075E54', padding: '1rem', color: 'white' }}>
            ...
            <div style={{ padding: '1rem' }}>
              <div style={{ backgroundColor: '#DCF8C6', padding: '0.75rem 1rem', borderRadius: '0 12px 12px 12px', marginBottom: '1rem', maxWidth: '85%' }}>
