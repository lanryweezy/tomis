      ...
      >
        <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 clamp(1rem, 4vw, 3rem)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: isScrolled ? '3.5rem' : '4.5rem', transition: 'height 0.4s ease' }}>
          ...
          <Link href="/" style={{ position: 'absolute', left: '50%', transform: 'translateX(-50%)', textDecoration: 'none' }}>
            <span className="font-display" style={{ fontSize: isScrolled ? '1.25rem' : '1.5rem', color: 'var(--text-primary)', transition: 'font-size 0.4s ease, color 0.3s ease', fontStyle: 'italic' }}>
              Tomis
            </span>
          </Link>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
            ...
            <button
              ...
              style={{ display: 'flex', width: '2.5rem', height: '2.5rem', alignItems: 'center', justifyContent: 'center', background: 'none', border: 'none', cursor: 'pointer', color: 'var(--text-primary)', transition: 'color 0.3s' }}
            ...
            <Link href="/cart" className="magnetic-btn" style={{ position: 'relative', display: 'flex', width: '2.5rem', height: '2.5rem', alignItems: 'center', justifyContent: 'center', color: 'var(--text-primary)', transition: 'color 0.3s' }} aria-label="Cart">
              ...
              {cartCount > 0 && (
                <span style={{ position: 'absolute', top: '-2px', right: '-2px', width: '16px', height: '16px', backgroundColor: 'var(--accent)', color: 'white', fontSize: '0.55rem', fontWeight: 700, borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  {cartCount}
                </span>
              )}
            </Link>
