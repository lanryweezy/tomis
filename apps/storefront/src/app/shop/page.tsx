...
// ⚡ Bolt Optimization: Memoize ProductCard to prevent unnecessary re-renders
// Impact: Significantly reduces React rendering workload during shop page filtering
// Measurement: Filter by color/collection with React DevTools profiler enabled to see skipped renders
const ProductCard = React.memo(function ProductCard({ product }: { product: typeof products[0] }) {
